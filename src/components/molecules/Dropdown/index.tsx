...
const Dropdown = (props: DropdownProps) => {
  ...
  const [isOpen, setIsOpenValue] = React.useState(false)
  ...
  const handleDocumentClick = React.useCallback(
    (e: MouseEvent | TouchEvent) => {
      if (dropdownRef.current) {
        ...
        // クリックした要素がドロップダウン内の要素かどうかをチェックする
        // ドロップダウン内の要素であれば、何もしないのでreturnすつ
      ...
      // クリックした要素がドロップダウン外の要素の場合、ドロップダウンを閉じる
    ...
    <DropdownRoot ref={dropdownRef}>
      ...
      >
        ...
        <input
          ...
          // TODO: なぜここで onChange を実行しているのかがわからない
